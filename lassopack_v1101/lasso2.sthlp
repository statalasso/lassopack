...
{synopt:{cmd:e(pmse)}}(standardized) minimized objective function (penalized mse, lasso/elastic net/ridge only){p_end}
{synopt:{cmd:e(prmse)}}(standardized) minimized objective function (penalized rmse, sqrt-lasso only){p_end}
