* rlasso cert script 1.0.10 MS 08nov2018
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	lalt corrnum(0) tolzero(1e-10) tolups(1e-10) tolopt(1e-8)		///
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	lalt corrnum(0) partial(_cons) tolzero(1e-10) tolups(1e-10)		///
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc one,	///
	lalt corrnum(0) tolzero(1e-10) tolups(1e-10) tolopt(1e-8)			///
	maxiter(10000) nocons pnotpen(one) maxupsiter(10) c0(0.55)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
mat beta=beta[1,1..`s']
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	lalt corrnum(0) partial(_cons) tolzero(1e-10) tolups(1e-10)		///
	tolopt(1e-8) maxiter(10000) maxupsiter(10) pnotpen(larea cbd)	///
	c0(0.55)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	lalt corrnum(0) tolzero(1e-10) tolups(1e-10) tolopt(1e-8)		///
	maxiter(10000) maxupsiter(10) partial(larea cbd)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
// Basic
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	rob lalt corrnum(0) tolzero(1e-10) tolups(1e-10) tolopt(1e-8)	///
	maxiter(10000) c0(0.55)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
...
// partial-out cons
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	rob lalt corrnum(0) partial(_cons) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) c0(0.55)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
// pnotpen
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	rob lalt corrnum(0) partial(_cons) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) pnotpen(larea cbd) c0(0.55)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
// partial
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	rob lalt corrnum(0) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) partial(larea cbd) c0(0.55)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	...
	tolzero(1e-10) tolups(1e-10) tolopt(1e-8)						///
	maxiter(10000) maxupsiter(10) c0(0.55)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	cluster(age) center corrnum(0) nclust1							///
	partial(_cons) tolzero(1e-10) tolups(1e-10) tolopt(1e-8)		///
	maxiter(10000) maxupsiter(10) c0(0.55)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	cluster(age) center corrnum(0) nclust1							///
	tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000)		///
	pnotpen(larea cbd) maxupsiter(10) c0(0.55)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	cluster(age) center corrnum(0) nclust1							///
	tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000)		///
	partial(larea cbd) maxupsiter(10) c0(0.55)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
