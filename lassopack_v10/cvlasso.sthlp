...
{bind:[{cmd:,}} {cmdab:a:lpha(}{it:numlist}{cmd:)}
{cmdab:alpha:count(}{it:int}{cmd:)}
{cmd:sqrt}
{cmdab:ada:ptive}
...
{cmd:nfolds}{cmd:(}{it:int}{cmd:)}
{cmd:foldvar}{cmd:(}{it:varname}{cmd:)}
{cmd:savefoldvar}{cmd:(}{it:varname}{cmd:)}
{cmdab:roll:ing}
...
{pstd}If {cmd:postest} is specified, {cmd:cvlasso} posts the {help lasso2} estimation results.{p_end}
{phang2}. {stata "cvlasso, lopt postest"}{p_end}
