* certification script for lasso2 1.0.06, 04/09/2018, aa
...
foreach li of numlist 0.1 1 3 5 10 50 100 {
 foreach ai of numlist  0 0.01 /* 0.25 */ 0.5 0.75 0.9 0.99 1 {
	...
	qui elasticregress $model, lambda(`lam') alpha(`ai') tol(10e-10)
	mat B = e(b)
...
mata: df1=trace(Xone*invsym((Xone'Xone):+20/2*Upscons)*Xone')  // this should be correct
