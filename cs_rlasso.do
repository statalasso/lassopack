* rlasso cert script 1.0.09 MS 09aug2018
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	lalt corrnum(0) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000)
mat b=e(b)
mat beta=e(beta)
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	lalt corrnum(0) partial(_cons) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
// Needs high setting for maxupsiter
// Also needs looser tolerance
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc one,	///
	lalt corrnum(0) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) nocons pnotpen(one) maxupsiter(10)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
mat beta=beta[1,1..`s']
...
// pnotpen
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	lalt corrnum(0) partial(_cons) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) maxupsiter(10) pnotpen(larea cbd)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
// partial
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	lalt corrnum(0) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) maxupsiter(10) partial(larea cbd)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
// Basic
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	rob lalt corrnum(0) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
// partial-out cons
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	rob lalt corrnum(0) partial(_cons) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
// pnotpen
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	rob lalt corrnum(0) partial(_cons) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) pnotpen(larea cbd)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
// partial
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	rob lalt corrnum(0) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) partial(larea cbd)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	...
	tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) maxupsiter(10)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	cluster(age) center corrnum(0) nclust1							///
	partial(_cons) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) maxupsiter(10)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	cluster(age) center corrnum(0) nclust1							///
	tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) pnotpen(larea cbd) maxupsiter(10)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	cluster(age) center corrnum(0) nclust1							///
	tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) partial(larea cbd) maxupsiter(10)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
assert mreldif(b,beta)<1e-8
...
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	rob tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) maxupsiter(10)
savedresults save rob e()
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	cluster(n) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) maxupsiter(10)
savedresults comp rob e(), exclude(macro: robust cluster)  tol(1e-8)

// center option
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	rob center tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) maxupsiter(10)
savedresults save rob e()
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	cluster(n) center tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) maxupsiter(10)
savedresults comp rob e(), exclude(macro: robust cluster)  tol(1e-8)
...
xtset age
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	fe tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) maxupsiter(10)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc i.age,	///
	partial(i.age) tolzero(1e-10) tolups(1e-10) tolopt(1e-8) maxiter(10000) maxupsiter(10)
...
xtset age
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	fe partial(larea cbd) tolzero(1e-10) tolups(1e-10) tolopt(1e-8)
mat b=e(b)
mat beta=e(beta)
mat betaOLS=e(betaOLS)
rlasso lrprice larea cbd intst lintst y81ldist lintstsq y81nrinc,	///
	fe pnotpen(larea cbd) tolzero(1e-10) tolups(1e-10) tolopt(1e-8)
mat btemp=e(b)
...
foreach opt in " " "sqrt" {
	...
	savedresults comp nostd e(), exclude(scalar: niter matrix: Ups) tol(1e-8)
...
foreach opt in	tolopt(1e-8) tolups(1e-3) tolzero(1e-3)	///
				maxiter(1000) maxupsiter(5)				///
				lassoups corrn(3) corrn(0)				///
...
assert mreldif(betaOLS,e(betaOLS))<1e-8
assert reldif(e(lambda0),104.19381954)<1e-8
...
assert mreldif(betaOLS,e(betaOLS))<1e-8
assert reldif(e(lambda0),106.220690035)<1e-8
...
assert mreldif(betaOLS,e(betaOLS))<1e-8
assert reldif(e(lambda0),108.37732392)<1e-8
...
assert reldif(e(supscore),30.98407884)<1e-8
assert reldif(e(supscore_p),0.240)<1e-8
assert reldif(e(supscore_cv),47.18084154)<1e-8
// critical value for gamma=5%
rlasso ynull cbd intst lintst y81ldist lintstsq y81nrinc, testonly gamma(0.05) seed(1)
assert reldif(e(supscore_cv),51.99509134)<1e-8
// heteroskedastic
rlasso ynull cbd intst lintst y81ldist lintstsq y81nrinc, testonly rob seed(1)
assert reldif(e(supscore),31.10453178)<1e-8
assert reldif(e(supscore_p),0.238)<1e-8
assert reldif(e(supscore_cv),47.18084154)<1e-8
// clustered
rlasso ynull cbd intst lintst y81ldist lintstsq y81nrinc, testonly cluster(id) seed(1)
assert reldif(e(supscore),3.19766215)<1e-8
assert reldif(e(supscore_p),0.160)<1e-8
assert reldif(e(supscore_cv),15.12760363)<1e-8
